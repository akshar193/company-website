      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
         ...
         <!--  <ul class="treeview-menu">
            <li><a href="{{ route('admin.index') }}"><i class="fa fa-circle-o"></i> Dashboard v1</a></li>
            <li class="active"><a href="{{ route('admin.index') }}"><i class="fa fa-circle-o"></i> Dashboard v2</a></li>
          </ul -->>
        </li>
      ...
      <!--   <li class="treeview">
       ...
       <!--  <li class="treeview">
         ...
         <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ route('datatable') }}"><i class="fa fa-circle-o"></i>View Query</a></li>
            <!-- <li><a href="{{ asset('pages/charts/morris.html') }}"><i class="fa fa-circle-o"></i> Morris</a></li>
            <li><a href="{{ asset('pages/charts/flot.html') }}"><i class="fa fa-circle-o"></i> Flot</a></li>
            <li><a href="{{ asset('pages/charts/inline.html') }}"><i class="fa fa-circle-o"></i> Inline charts</a></li> -->
          </ul>
...
<!-- Tables -->
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; AxtersHub pvt ltd.</strong> All rights
    reserved.
  </footer>
