	...
	<div class="container">
		<nav class="navbar navbar-inverse navbar-static-top">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#0"><h1>Axters<h style="color: #DF0023;">HUB</h></h1></a>
			</div>
			<div id="navbar" class="navbar-collapse collapse">
				<ul class="nav navbar-nav cl-effect-18">
					<li><a href="#home" class="page-scroll" data-hover="Home" >Home</a></li>
...
<!-- /navigation -->
<!-- banner section -->
<section class="banner-w3ls" id="home">
	<div class='header'>
		<div class="container">
			<div class="banner-agileits">
				<h2>Buiding future ,not just domanins</h2>	
				<ul class="social-icons1">
					<li><a href="https://www.facebook.com/AxtersHub/" target="_blank"><i class="fa fa-facebook"></i></a></li>
...
<section class="about-agileits" id="about">
	<div class="container">
		<div class="col-lg-6 col-md-6 col-sm-12 about-w3ls1" data-aos="zoom-in" style="margin-top:10%; !important">
		...
		<div class="col-lg-6 col-md-6 col-sm-12 about-w3ls2" data-aos="zoom-in" style="margin-top:10%; !important">
			<div class="about-w3l">
	...
	<div class="container">
		...
		<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 team-agile1" data-aos="flip-up">
			<div class="view view-eighth">
                <img src="img/team-img1.jpg" alt="" class="img-responsive"/>
                <div class="mask">
                    <h4>Elizabeth</h4>
		...
		<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 team-agile2" data-aos="flip-up">
			<div class="view view-eighth">
                <img src="img/team-img2.jpg" alt="" class="img-responsive"/>
                <div class="mask">
                    <h4>James Cameron</h4>
					<ul class="team-social">
						<li><a href="#"><i class="fa fa-facebook"></i></a></li>
		...
		<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 team-agile3" data-aos="flip-up">
			<div class="view view-eighth">
                <img src="img/team-img3.jpg" alt="" class="img-responsive"/>
                <div class="mask">
                    <h4>Max Payne</h4>
                    <ul class="team-social">
						<li><a href="#"><i class="fa fa-facebook"></i></a></li>
		...
		<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 team-agile4" data-aos="flip-up">
			<div class="view view-eighth">
                <img src="img/team-img4.jpg" alt="" class="img-responsive"/>
                <div class="mask">
                    <h4>Stephen John</h4>
                    <ul class="team-social">
						<li><a href="#"><i class="fa fa-facebook"></i></a></li>
		...
		<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
			...
			<div id="myTabContent" class="tab-content">
				<div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
					<div class="tab_img">
						<div class="col-md-3 col-sm-6 col-xs-6 portfolio-grids" data-aos="zoom-in">
							<a href="img/port-img1.jpg" class="b-link-stripe b-animate-go lightninBox" data-lb-group="1">
								<img src="img/port-img1.jpg" class="img-responsive" alt="w3ls" />
								<div class="b-wrapper">
						...
						<div class="col-md-3 col-sm-6 col-xs-6 portfolio-grids" data-aos="zoom-in">
							<a href="img/port-img2.jpg" class="b-link-stripe b-animate-go lightninBox" data-lb-group="1">
								<img src="img/port-img2.jpg" class="img-responsive" alt="w3ls"/>
								<div class="b-wrapper">
									<i class="fa fa-search-plus" aria-hidden="true"></i>
									<h5>Teaching</h5>
									<p>Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet.</p>
						...
						<div class="col-md-3 col-sm-6 col-xs-6 portfolio-grids" data-aos="zoom-in">
							<a href="img/port-img3.jpg" class="b-link-stripe b-animate-go lightninBox" data-lb-group="1">
								<img src="img/port-img3.jpg" class="img-responsive" alt="w3ls"/>
								<div class="b-wrapper">
									<i class="fa fa-search-plus" aria-hidden="true"></i>
									<h5>Learning</h5>
									<p>Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet.</p>
						...
						<div class="col-md-3 col-sm-6 col-xs-6 portfolio-grids" data-aos="zoom-in">
							<a href="img/port-img4.jpg" class="b-link-stripe b-animate-go lightninBox" data-lb-group="1">
								<img src="img/port-img4.jpg" class="img-responsive" alt="w3ls"/>
								<div class="b-wrapper">
									<i class="fa fa-search-plus" aria-hidden="true"></i>
									<h5>Learning</h5>
									<p>Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet.</p>
					...
					<div class="tab_img">
						<div class="col-md-3 col-sm-6 col-xs-6 portfolio-grids" data-aos="zoom-in">
							<a href="img/port-img5.jpg" class="b-link-stripe b-animate-go lightninBox" data-lb-group="1">
								<img src="img/port-img5.jpg" class="img-responsive" alt="w3ls"/>
								<div class="b-wrapper">
									<i class="fa fa-search-plus" aria-hidden="true"></i>
									<h5>Learning</h5>
									<p>Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet.</p>
						...
						<div class="col-md-3 col-sm-6 col-xs-6 portfolio-grids" data-aos="zoom-in">
							<a href="img/port-img6.jpg" class="b-link-stripe b-animate-go lightninBox" data-lb-group="1">
								<img src="img/port-img6.jpg" class="img-responsive" alt="w3ls"/>
								<div class="b-wrapper">
									<i class="fa fa-search-plus" aria-hidden="true"></i>
									<h5>Teaching</h5>
									<p>Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet.</p>
						...
						<div class="col-md-3 col-sm-6 col-xs-6 portfolio-grids" data-aos="zoom-in">
							<a href="img/port-img7.jpg" class="b-link-stripe b-animate-go lightninBox" data-lb-group="1">
								<img src="img/port-img7.jpg" class="img-responsive" alt="w3ls"/>
								<div class="b-wrapper">
									<i class="fa fa-search-plus" aria-hidden="true"></i>
									<h5>Awards</h5>
									<p>Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet.</p>
						...
						<div class="col-md-3 col-sm-6 col-xs-6 portfolio-grids" data-aos="zoom-in">
							<a href="img/port-img8.jpg" class="b-link-stripe b-animate-go lightninBox" data-lb-group="1">
								<img src="img/port-img8.jpg" class="img-responsive" alt="w3ls"/>
								<div class="b-wrapper">
									<i class="fa fa-search-plus" aria-hidden="true"></i>
									<h5>Training</h5>
									<p>Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet.</p>
						...
						<div class="col-md-3 col-sm-6 col-xs-6 portfolio-grids" data-aos="zoom-in">
							<a href="img/port-img9.jpg" class="b-link-stripe b-animate-go lightninBox" data-lb-group="1">
								<img src="img/port-img9.jpg" class="img-responsive" alt="w3ls"/>
								<div class="b-wrapper">
									<i class="fa fa-search-plus" aria-hidden="true"></i>
									<h5>Awards</h5>
									<p>Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet.</p>
						...
						<div class="col-md-3 col-sm-6 col-xs-6 portfolio-grids" data-aos="zoom-in">
							<a href="img/port-img10.jpg" class="b-link-stripe b-animate-go lightninBox" data-lb-group="1">
								<img src="img/port-img10.jpg" class="img-responsive" alt="w3ls"/>
								<div class="b-wrapper">
									<i class="fa fa-search-plus" aria-hidden="true"></i>
									<h5>Awards</h5>
									<p>Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet.</p>
						...
						<div class="col-md-3 col-sm-6 col-xs-6 portfolio-grids" data-aos="zoom-in">
							<a href="img/port-img11.jpg" class="b-link-stripe b-animate-go lightninBox" data-lb-group="1">
								<img src="img/port-img11.jpg" class="img-responsive" alt="w3ls"/>
								<div class="b-wrapper">
									<i class="fa fa-search-plus" aria-hidden="true"></i>
									<h5>Teaching</h5>
									<p>Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet.</p>
						...
						<div class="col-md-3 col-sm-6 col-xs-6 portfolio-grids" data-aos="zoom-in">
							<a href="img/port-img12.jpg" class="b-link-stripe b-animate-go lightninBox" data-lb-group="1">
								<img src="img/port-img12.jpg" class="img-responsive" alt="w3ls"/>
								<div class="b-wrapper">
									<i class="fa fa-search-plus" aria-hidden="true"></i>
									<h5>Awards</h5>
									<p>Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet.</p>
				...
				<div role="tabpanel" class="tab-pane fade" id="teach" aria-labelledby="teach-tab">
					<div class="tab_img">
						<div class="col-md-3 col-sm-6 col-xs-6 portfolio-grids" data-aos="zoom-in">
							<a href="img/port-img2.jpg" class="b-link-stripe b-animate-go lightninBox" data-lb-group="2">
								<img src="img/port-img2.jpg" class="img-responsive zoom-img" alt="w3ls"/>
								<div class="b-wrapper">
									<i class="fa fa-search-plus" aria-hidden="true"></i>
									<h5>Teaching</h5>
									<p>Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet.</p>
						...
						<div class="col-md-3 col-sm-6 col-xs-6 portfolio-grids" data-aos="zoom-in">
							<a href="img/port-img6.jpg" class="b-link-stripe b-animate-go lightninBox" data-lb-group="2">
								<img src="img/port-img6.jpg" class="img-responsive zoom-img" alt="w3ls"/>
								<div class="b-wrapper">
									<i class="fa fa-search-plus" aria-hidden="true"></i>
									<h5>Teaching</h5>
									<p>Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet.</p>
						...
						<div class="col-md-3 col-sm-6 col-xs-6 portfolio-grids" data-aos="zoom-in">
							<a href="img/port-img11.jpg" class="b-link-stripe b-animate-go lightninBox" data-lb-group="2">
								<img src="img/port-img11.jpg" class="img-responsive zoom-img" alt="w3ls"/>
								<div class="b-wrapper">
									<i class="fa fa-search-plus" aria-hidden="true"></i>
									<h5>Teaching</h5>
									<p>Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet.</p>
				...
				<div role="tabpanel" class="tab-pane fade" id="train" aria-labelledby="train-tab">
					<div class="tab_img">
						<div class="col-md-3 col-sm-6 col-xs-6 portfolio-grids" data-aos="zoom-in">
							<a href="img/port-img1.jpg" class="b-link-stripe b-animate-go lightninBox" data-lb-group="3">
								<img src="img/port-img1.jpg" class="img-responsive zoom-img" alt="w3ls"/>
								<div class="b-wrapper">
									<i class="fa fa-search-plus" aria-hidden="true"></i>
									<h5>Training</h5>
									<p>Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet.</p>
						...
						<div class="col-md-3 col-sm-6 col-xs-6 portfolio-grids" data-aos="zoom-in">
							<a href="img/port-img8.jpg" class="b-link-stripe b-animate-go lightninBox" data-lb-group="3">
								<img src="img/port-img8.jpg" class="img-responsive zoom-img" alt="w3ls"/>
								<div class="b-wrapper">
									<i class="fa fa-search-plus" aria-hidden="true"></i>
									<h5>Training</h5>
									<p>Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet.</p>
				...
				<div role="tabpanel" class="tab-pane fade" id="learn" aria-labelledby="learn-tab">
					<div class="tab_img">
						<div class="col-md-3 col-sm-6 col-xs-6 portfolio-grids" data-aos="zoom-in">
							<a href="img/port-img3.jpg" class="b-link-stripe b-animate-go lightninBox" data-lb-group="4">
								<img src="img/port-img3.jpg" class="img-responsive zoom-img" alt="w3ls"/>
								<div class="b-wrapper">
									<i class="fa fa-search-plus" aria-hidden="true"></i>
									<h5>Learning</h5>
									<p>Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet.</p>
						...
						<div class="col-md-3 col-sm-6 col-xs-6 portfolio-grids" data-aos="zoom-in">
							<a href="img/port-img4.jpg" class="b-link-stripe b-animate-go lightninBox" data-lb-group="4">
								<img src="img/port-img4.jpg" class="img-responsive zoom-img" alt="w3ls"/>
								<div class="b-wrapper">
									<i class="fa fa-search-plus" aria-hidden="true"></i>
									<h5>Learning</h5>
									<p>Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet.</p>
						...
						<div class="col-md-3 col-sm-6 col-xs-6 portfolio-grids" data-aos="zoom-in">
							<a href="img/port-img5.jpg" class="b-link-stripe b-animate-go lightninBox" data-lb-group="4">
								<img src="img/port-img5.jpg" class="img-responsive zoom-img" alt="w3ls"/>
								<div class="b-wrapper">
									<i class="fa fa-search-plus" aria-hidden="true"></i>
									<h5>Learning</h5>
									<p>Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet.</p>
				...
				<div role="tabpanel" class="tab-pane fade" id="award" aria-labelledby="award-tab">
					<div class="tab_img">
						<div class="col-md-3 col-sm-6 col-xs-6 portfolio-grids" data-aos="zoom-in">
							<a href="img/port-img7.jpg" class="b-link-stripe b-animate-go lightninBox" data-lb-group="5">
								<img src="img/port-img7.jpg" class="img-responsive zoom-img" alt="w3ls"/>
								<div class="b-wrapper">
									<i class="fa fa-search-plus" aria-hidden="true"></i>
									<h5>Awards</h5>
									<p>Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet.</p>
						...
						<div class="col-md-3 col-sm-6 col-xs-6 portfolio-grids" data-aos="zoom-in">
							<a href="img/port-img9.jpg" class="b-link-stripe b-animate-go lightninBox" data-lb-group="5">
								<img src="img/port-img9.jpg" class="img-responsive zoom-img" alt="w3ls"/>
								<div class="b-wrapper">
									<i class="fa fa-search-plus" aria-hidden="true"></i>
									<h5>Awards</h5>
									<p>Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet.</p>
						...
						<div class="col-md-3 col-sm-6 col-xs-6 portfolio-grids" data-aos="zoom-in">
							<a href="img/port-img10.jpg" class="b-link-stripe b-animate-go lightninBox" data-lb-group="5">
								<img src="img/port-img10.jpg" class="img-responsive zoom-img" alt="w3ls"/>
								<div class="b-wrapper">
									<i class="fa fa-search-plus" aria-hidden="true"></i>
									<h5>Awards</h5>
									<p>Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet.</p>
						...
						<div class="col-md-3 col-sm-6 col-xs-6 portfolio-grids" data-aos="zoom-in">
							<a href="img/port-img12.jpg" class="b-link-stripe b-animate-go lightninBox" data-lb-group="5">
								<img src="img/port-img12.jpg" class="img-responsive zoom-img" alt="w3ls"/>
								<div class="b-wrapper">
									<i class="fa fa-search-plus" aria-hidden="true"></i>
									<h5>Awards</h5>
									<p>Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet.</p>
...
<section class="contact-wthree jarallax" id="contact">
	<div class="container">
		...
		<div class="col-lg-2 col-md-2 col-sm-2" data-aos="zoom-in">
			<!-- <img src="img/contact-img1.jpg" alt="" class="img-circle img-responsive"> -->
		</div>
		...
		<div class="col-lg-12" data-aos="zoom-in">
			<ul class="contact-info">
				<li>
					...
					<p class="contact-p1">+91-9711681951</p>
					<p class="contact-p2">+91-9818284472</p>
				</li>
				<li>
					<i class="fa fa-envelope" aria-hidden="true"></i>
					<p class="contact-p1"><a href="mailto:amita.srivastava@axters.com">amita.srivastava@axters.com</a></p>
					<p class="contact-p2"><a href="mailto:akash.sharma@axters.com">akash.sharma@axters.com</a></p>
				</li>
				<li>
		...
		<div class="clearfix"></div>	
		<form action="/send" method="get" name="sentMessage" id="contactForm" novalidate>
...
<section class="footer-wthree">
	<div class="container">
		...
		<div class="col-lg-4 col-md-4 col-sm-12 footer-grid" data-aos="zoom-in">
			...
			<ul class="clearfix demo">
				<li><img src="img/footer-pic1.jpg" alt="" class="img-responsive"/></li>
				<li><img src="img/footer-pic2.jpg" alt="" class="img-responsive"/></li>
				<li><img src="img/footer-pic3.jpg" alt="" class="img-responsive"/></li>
				<li><img src="img/footer-pic4.jpg" alt="" class="img-responsive"/></li>
				<li><img src="img/footer-pic5.jpg" alt="" class="img-responsive"/></li>
				<li><img src="img/footer-pic6.jpg" alt="" class="img-responsive"/></li>	
				<li><img src="img/footer-pic7.jpg" alt="" class="img-responsive"/></li>
				<li><img src="img/footer-pic8.jpg" alt="" class="img-responsive"/></li>
				<li><img src="img/footer-pic9.jpg" alt="" class="img-responsive"/></li>
			</ul> -->
			<h3>Address</h3>
			<span class="line2"></span>
			<ul class="footer-news">
				<li>
					<div class="news-content">
						<a href="#" class="news-header" data-toggle="modal" data-target="#news1"><h4>Reach Us</h4></a>
						<p class="news-p1">Jaipuria Sunrise Plaza Plot No.12(A), Ahinsa Khand Indrapuram Shop No.104(A) and 117(A), Ghaziabad (U.P.).</p>
					</div>
				</li>
			</ul>
		</div>
		<div class="col-lg-4 col-md-4 col-sm-12 footer-grid" data-aos="zoom-in">
			...
			<ul class="footer-news">
				<li>
					...
					<div class="news-pic">
						<a href="#" data-toggle="modal" data-target="#news1"><img src="img/news-pic1.jpg" alt="" class="img-responsive"></a>
					</div>
					<div class="clearfix"></div>
				</li>
				<li>
					...
					<div class="news-pic">
						<a class="#" data-toggle="modal" data-target="#news2"><img src="img/news-pic2.jpg" alt="" class="img-responsive"></a>
					</div>
					<div class="clearfix"></div>
				</li>
			</ul>
	...
	<p class="copyright">© <b>Axters</b>HUB Pvt. Ltd. </p>
	<div class="modal fade" id="news1" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="col-lg-6 col-md-6 col-sm-12">
						<img src="img/news-img1.jpg" alt="" class="img-responsive">
					</div>
					<div class="col-lg-6 col-md-6 col-sm-12">
						<p class="news-info">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi pharetra laoreet aliquet. Sed tristique ex lectus, ut maximus ipsum tempus a. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse porttitor eros quis leo bibendum, eu bibendum ligula malesuada.</p>
					</div>
	...
	<div class="modal fade" id="news2" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="col-lg-6 col-md-6 col-sm-12">
						<img src="img/news-img2.jpg" alt="" class="img-responsive">
					</div>
					<div class="col-lg-6 col-md-6 col-sm-12">
						<p class="news-info">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi pharetra laoreet aliquet. Sed tristique ex lectus, ut maximus ipsum tempus a. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse porttitor eros quis leo bibendum, eu bibendum ligula malesuada.</p>
					</div>
